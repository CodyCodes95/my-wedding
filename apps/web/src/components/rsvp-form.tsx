    ...
    <form onSubmit={onSubmit} className="grid gap-6">
      <fieldset className="grid gap-3">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <label className="flex cursor-pointer items-center gap-3 rounded-md border border-input bg-white p-3 transition-colors has-[input:focus-visible]:ring-[3px] has-[input:focus-visible]:ring-ring/50 hover:bg-accent/40">
            <input
      ...
      <div className="grid gap-2">
        ...
        {plusOne ? (
          <div aria-hidden={!plusOne} className="grid gap-2" id="plus-one-section">
